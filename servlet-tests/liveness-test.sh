...
main() {
  ...
  echo "{\"unapproved\": [{ \"projectName\": \"TestProject\",\"appId\": \"testapp1\",\"safeName\": \"PetClinicDev\",\"environment\": \"test\",\"dateTime\": \"2021-07-15 18:36:35\",\"accReqId\": 3}]}"
  echo
  ...
  echo
  echo "Output above provided for comparison. If all is configured properly you should see similar below:"
  echo
